...
class SearchProvider : SearchIndexablesProvider() {
    ...
    override fun queryRawData(projection: Array<String>?): Cursor {
        ...
        ref[COLUMN_INDEX_RAW_SUMMARY_ON] = requireContext().getString(R.string.setting_enabled_summary)
        ref[COLUMN_INDEX_RAW_KEYWORDS] = requireContext().getString(R.string.settings_search_keywords)

        // For breadcrumb generation
        ref[COLUMN_INDEX_RAW_SCREEN_TITLE] = requireContext().getString(R.string.settings_entry_title)
